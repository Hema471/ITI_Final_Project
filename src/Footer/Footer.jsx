            ...
            <div className="row">
              <div className="col-xs-12 col-sm-6 col-md-3">
                <div className="widget subscribe no-box">
                  ...
                  <p>
                    Welcome to MovieVerse best animation movie website, MovieVerse
                    is designed to provide users with an immersive movie
                    experience. It offers a variety of features that enhance
                    your movie discovery, selection, and interaction.
                  </p>
                </div>
              </div>
              <div className="col-xs-12 col-sm-6 col-md-3">
              ...
              <div className="col-xs-12 col-sm-6 col-md-3">
                <div className="widget no-box">
                  ...
                  <p>
                    <Link title="glorythemes">ibrahimismailhefzallah@gmail.com</Link>
                  </p>
